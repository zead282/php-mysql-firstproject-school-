...
{
	if(!empty($_POST["sub1"]) && !empty($_POST["sub2"]) && !empty($_POST["sub3"]))
	{ 
		$subject=new Subject();
...
<form method="post" >
  ...
  <input class="form-control" name="sub1" id="sub1"  value="<?php?>" required="required">       
											</div>
		...
		<div class="col-lg-6">
<input class="form-control" name="sub2" id="sub2" value="<?php ?>" required="required">         
		</div>
	 </div>	
	 ...
	 <br><br>								
		...
		<div class="col-lg-6">
<input class="form-control" name="sub3" id="sub3" value="<?php ?>" required="required">         
		</div>
	 </div>	
